    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h2>Maestro de Clientes por Ruta</h2>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="../principal.php">Inicio</a></li>
                            <li class="breadcrumb-item active">Maestro de Clientes por Ruta</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="content">
            ...
            <div class="card card-info" id="tabla">
                <div class="card-header">
                    <h3 class="card-title">Relación de Clientes por Ruta</h3>
                </div>
                <div class="card-body" style="width:auto;">
                    <table class="table table-hover table-condensed table-bordered table-striped text-center" style="width:100%;" id="maestro_data">
...
<?php require_once("../footer.php");?>
    <script type="text/javascript" src="maestroclientes.js"></script><?php
}
?>
</body>
</html>
