...
function datadetalles() {
    ...
    var vendedor = urlParams.get('vendedor');
...
//alert( fechai +' '+ fechaf +' '+ dataop );
    ...
    sessionStorage.setItem("vendedor", vendedor);
            ...
            tabla = $('#cobrar_data_detalle').DataTable({
                ...
                "ajax":{
                    url: "Fact_cobrar_controlador.php?op=detalle_de_facturas",
                    type: "post",
                    dataType: "json",
                    data: { vendedor:vendedor , dataop:dataop},
                    beforeSend: function () {
...
$(document).on("click","#btn_excel_detalle", function(){
    ...
    window.location = "Fact_cobrardetalles_excel.php?&fechai="+fechai+"&fechaf="+fechaf+"&data="+dataop;
