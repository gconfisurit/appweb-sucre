    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h2>Razones de No VENTA</h2>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="../principal.php">Inicio</a></li>
                            <li class="breadcrumb-item active">Razones de No VENTA</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="content">
            ...
            <div class="card card-info" id="tabla">
                <div class="card-header">
                    <h3 class="card-title">Relación de Razones de No VENTA</h3>
                </div>
                <div class="card-body" style="width:auto;">
                    <table class="table table-hover table-condensed table-bordered table-striped text-center" style="width:100%;" id="motivonoventa_data">
                        ...
                        <tr>
                            ...
                            <th class="text-center" title="<?=Strings::DescriptionFromJson('causa')?>"><?=Strings::titleFromJson('causa')?></th>
                        </tr>
                        </thead>
                        ...
                        <tr>
                            ...
                            <th class="text-center"><?=Strings::titleFromJson('causa')?></th>
                        </tr>
                        </tfoot>
                        <tbody>
...
<?php require_once("../footer.php");?>
    <script type="text/javascript" src="motivonoventa.js"></script><?php
}
?>
</body>
</html>
