...
class ClientesCodNestle extends Conectar{
	...
	public function getClientes_cnestle($opc,$vendedor){
		...
		if(hash_equals("-", $vendedor)){
			switch ($opc){
				case "1":
				$sql = "SELECT a.CodVend as codvend, a.CodClie as codclie, a.Descrip as descrip, a.FechaE as fecha, a.ID3 as rif, b.DiasVisitas as dvisita, b.CodNestle as codnestle, b.Clasificacion as clasificacion FROM saclie as a INNER JOIN saclie_01 as b ON a.codclie = b.codclie ORDER BY a.codvend, a.codclie";
				break;
				case "2":
				$sql = "SELECT a.CodVend as codvend, a.CodClie as codclie, a.Descrip as descrip, a.FechaE as fecha, a.ID3 as rif, b.DiasVisitas as dvisita, b.CodNestle as codnestle, b.Clasificacion as clasificacion FROM saclie as a INNER JOIN saclie_01 as b ON a.codclie = b.codclie WHERE (LEN(b.codnestle) > 3) AND codnestle IS NOT NULL ORDER BY a.codvend, a.codclie";
				break;
				case "3":
			...
			switch ($opc){
				case "1":
				$sql = "SELECT a.CodVend as codvend, a.CodClie as codclie, a.Descrip as descrip, a.FechaE as fecha, a.ID3 as rif, b.DiasVisitas as dvisita, b.CodNestle as codnestle, b.Clasificacion as clasificacion FROM saclie as a INNER JOIN saclie_01 as b ON a.codclie = b.codclie WHERE a.codvend = ? ORDER BY a.codvend, a.codclie";
				break;
				case "2":
