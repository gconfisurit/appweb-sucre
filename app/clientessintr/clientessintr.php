<?php
session_name('S1sTem@@PpWebGruP0C0nF1SuR_SUCRE');
session_start();
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    if (!PermisosHelpers::verficarAcceso( Functions::getNameDirectory() )) {
            ...
            <section class="content">
                ...
                <div class="card card-info">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-success" id="btn_clientessintr"><i class="fa fa-search" aria-hidden="true"></i><?=Strings::titleFromJson('boton_consultar')?></button>
                    </div>
                </div>
                ...
                <div class="card card-info" id="tabla">
                    ...
                    <div class="card-body" style="width:auto;">
                        <table class="table table-hover table-condensed table-bordered table-striped text-center" style="width:100%;" id="clientessintr_data">
                            <thead style="background-color: #17A2B8;color: white;">
                                <tr>
                                    ...
                                    <th class="text-center" title="<?=Strings::DescriptionFromJson('saldo_bs')?>"><?=Strings::titleFromJson('saldo_bs')?></th>
                                </tr>
                            </thead>
                            <tfoot style="background-color: #ccc;color: white;">
                                <tr>
                                    ...
                                    <th class="text-center"><?=Strings::titleFromJson('saldo_bs')?></th>
                                </tr>
                            </tfoot>
                            <tbody>
        ...
        <script type="text/javascript" src="clientessintr.js"></script><?php
    }
    ?>
</body>
