...
class Clientesbloqueados extends Conectar{
	...
	public function ClientesBloqueadosPorVendedor($vendedor){
        ...
        //QUERY
		$sql= "SELECT cli.codclie as codclie, cli.descrip as descrip, cli.id3 as id3, cli.Direc1 AS direc1, cli.Direc2 AS direc2, cli.EsCredito AS escredito, cli.Observa AS observa, cli01.DiasVisitas AS diasvisita  FROM SACLIE AS CLI INNER JOIN saclie_01 AS CLI01 ON CLI.codclie = CLI01.codclie WHERE CLI.codclie IN
