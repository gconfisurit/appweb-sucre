...
function listar_tabladinamica(){
    ...
    $.ajax({
        url: "sabana_tabladinamica_controlador.php?op=listar_tabladinamica",
        method: "POST",
...
function tabladinamica(data) {
    ...
    if (!jQuery.isEmptyObject(tabla))
    {
        $.each(tabla, function(idx, opt) {
            $('#tabla').append(
                ...
                '<td align="center" class="small align-middle">' + opt.costod + '</td>' +
                '<td align="center" class="small align-middle">' + opt.total_costod + '</td>' +
                '<td align="center" class="small align-middle">' + opt.renta_bruta + '</td>' +
                '<td align="center" class="small align-middle">' + opt.rentabilidad + ' %</td>' +
    ...
    $('#tabla').append(
        ...
        '<td align="center" class="small text-right" '+bold+'>' + totales.costod + '</td>' +
        '<td align="center" class="small text-right" '+bold+'>' + totales.costo_total + '</td>' +
        '<td align="center" class="small text-right" ' + bold + '>' + totales.renta_bruta + '</td>' +
        '<td align="center" class="small text-right" ' + bold + '>' + totales.renta + ' %</td>' +
        '<td align="center" class="small text-right" '+bold+'></td>' +
        '<td align="center" class="small text-right" '+bold+'></td>' +
        '<td align="center" class="small text-right" '+bold+'></td>' +
        '<td align="center" class="small text-right" '+bold+'></td>' +
